...
- **視覚的な音作り**：回転ノブ、LCD波形表示、ピッチ／包絡グラフ、鍵盤、8ステップの音程変化、12プリセット。
...
Releasesから `RetroSFX-Studio-v1.0.0-win-x64.zip` をダウンロードし、**ZIP全体を展開**してください。`_internal` フォルダーも必要です。
...
1. 上部で音源、PROGRAMでプリセットを選択します（12種）。
...
検証には全音源の440 Hz測定、左右出力、ゼロ音量、12プリセットの再現性、
