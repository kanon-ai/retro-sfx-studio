...
python -m PyInstaller --noconfirm --clean --onedir --name RetroSFX --add-data 'static;static' --add-binary 'bin/retro_render.exe;bin' --add-data 'vendor/ymfm/LICENSE;licenses' --add-data 'licenses;licenses' --add-data 'templates;templates' launcher.py
